...
class FormulaCreationFrame(Frame):
    ...
    def __init__(self, parent):
        ...
        btn_blank_power.grid(row=1, column=1, padx=2, pady=5)
        ...
        btn_square_root.grid(row=1, column=5, padx=2, pady=5)

        cube_root = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\cube_root.png")
        ...
        btn_blank_root.grid(row=1, column=7, padx=2, pady=5)
        ...
        btn_left_bracket.grid(row=1, column=8, padx=2, pady=5)
        ...
        btn_right_bracket.grid(row=1, column=9, padx=2, pady=5)
        ...
        btn_multiplication.grid(row=1, column=10, padx=2, pady=5)
        ...
        btn_sin.image = sin
        btn_sin.grid(row=2, column=0, padx=2, pady=5)
        ...
        btn_tan.image = tan
        btn_tan.grid(row=2, column=2, padx=2, pady=5)
        ...
        array5 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\array5.png")
        ...
        btn_variable_a.grid(row=2, column=5, padx=2, pady=5)
        ...
        btn_variable_b.grid(row=2, column=6, padx=2, pady=5)
        ...
        btn_variable_c.grid(row=2, column=7, padx=2, pady=5)
        ...
        btn_variable_d.grid(row=2, column=8, padx=2, pady=5)

        variable_e = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\variable_e.png")
        ...
        btn_variable_e.grid(row=2, column=9, padx=2, pady=5)
        ...
        btn_divison.grid(row=2, column=10, padx=2, pady=5)
        ...
        btn_arc_sin.grid(row=3, column=0, padx=2, pady=5)
        ...
        btn_arc_cos.grid(row=3, column=1, padx=2, pady=5)
        ...
        btn_arc_tan.grid(row=3, column=2, padx=2, pady=5)

        array10 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\array10.png")
        ...
        array15 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\array15.png")
        ...
        variable_f = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\variable_f.png")
        ...
        btn_variable_f.grid(row=3, column=5, padx=2, pady=5)

        variable_g = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\variable_g.png")
        ...
        btn_variable_g.grid(row=3, column=6, padx=2, pady=5)

        variable_h = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\variable_h.png")
        ...
        btn_variable_h.grid(row=3, column=7, padx=2, pady=5)

        variable_i = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\variable_i.png")
        ...
        btn_variable_i.grid(row=3, column=8, padx=2, pady=5)

        variable_j = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\variable_j.png")
        ...
        btn_variable_j.grid(row=3, column=9, padx=2, pady=5)
        ...
        btn_subtraction.grid(row=3, column=10, padx=2, pady=5)

        num0 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num0.png")
        btn_num0 = Button(self, relief=RAISED, image=num0, command=lambda: self.update_text("0"))
        btn_num0.image = num0
        btn_num0.grid(row=4, column=0, padx=2, pady=5)

        num1 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num1.png")
        btn_num1 = Button(self, relief=RAISED, image=num1, command=lambda: self.update_text("1"))
        btn_num1.image = num1
        btn_num1.grid(row=4, column=1, padx=2, pady=5)

        num2 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num2.png")
        btn_num2 = Button(self, relief=RAISED, image=num2, command=lambda: self.update_text("2"))
        btn_num2.image = num2
        btn_num2.grid(row=4, column=2, padx=2, pady=5)

        num3 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num3.png")
        btn_num3 = Button(self, relief=RAISED, image=num3, command=lambda: self.update_text("3"))
        btn_num3.image = num3
        btn_num3.grid(row=4, column=3, padx=2, pady=5)

        num4 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num4.png")
        btn_num4 = Button(self, relief=RAISED, image=num4, command=lambda: self.update_text("4"))
        btn_num4.image = num4
        btn_num4.grid(row=4, column=4, padx=2, pady=5)

        num5 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num5.png")
        btn_num5 = Button(self, relief=RAISED, image=num5, command=lambda: self.update_text("5"))
        btn_num5.image = num5
        btn_num5.grid(row=4, column=5, padx=2, pady=5)

        num6 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num6.png")
        ...
        num7 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num7.png")
        btn_num7 = Button(self, relief=RAISED, image=num7, command=lambda: self.update_text("7"))
        btn_num7.image = num7
        btn_num7.grid(row=4, column=7, padx=2, pady=5)

        num8 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num8.png")
        btn_num8 = Button(self, relief=RAISED, image=num8, command=lambda: self.update_text("8"))
        btn_num8.image = num8
        btn_num8.grid(row=4, column=8, padx=2, pady=5)

        num9 = PhotoImage(file=r"C:\Users\enggd\PycharmProjects\nea-calculator\icons\num9.png")
        btn_num9 = Button(self, relief=RAISED, image=num9, command=lambda: self.update_text("9"))
        btn_num9.image = num9
        btn_num9.grid(row=4, column=9, padx=2, pady=5)
        ...
        btn_addition.grid(row=4, column=10, padx=2, pady=5)
